...
local Window = Fluent:CreateWindow({
    Title = "TDB HUB [ Premium ] – BLOXFRUITS",
    SubTitle = "By DuyBach",
    TabWidth = 155,
...
local CheckSoul = Tabs.Mirage:AddParagraph({
    Title = " Làm Nhiệu Vụ Skull Guitar ",
    Content = ""
})
spawn(function()
    while wait(.2) do
...
local Q = Tabs.Mirage:AddToggle("Q", {
    Title = "Farm Nguyên Liệu Skull Guitar",
    Description = "",
    Default = false
})
Q:OnChanged(function(Value)
...
local Q = Tabs.Mirage:AddToggle("Q", {
    Title = "Auto Kill Người Chơi Trial",
...
ImageButton.Image = "http://www.roblox.com/asset/?id=92417163738850";
